...
vehicleRouterV1.post("/vehicles/register", (req, res) =>
  registerVehicleController.execute(req, res)
);

vehicleRouterV1.put("/vehicles/:vehicleId", (req, res) =>
  updateVehicleController.execute(req, res)
);

vehicleRouterV1.get("/vehicles", (req, res) =>
  fetchVehiclesController.execute(req, res)
);
